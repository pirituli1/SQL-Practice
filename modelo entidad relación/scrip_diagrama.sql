...
CREATE TABLE IF NOT EXISTS `mydb`.`order_detail` (
  ...
  PRIMARY KEY (`orden_id`, `Product_ID`, `id`),
  INDEX `fk_orden_has_Product_Product1_idx` (`Product_ID` ASC) VISIBLE,
  INDEX `fk_orden_has_Product_orden1_idx` (`orden_id` ASC) VISIBLE,
  CONSTRAINT `fk_orden_has_Product_orden1`
    FOREIGN KEY (`orden_id`)
    REFERENCES `mydb`.`orden` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_has_Product_Product1`
